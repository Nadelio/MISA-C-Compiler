...
typedef enum {
	BUILTIN_NONE = 0,
	BUILTIN_PRINT_INT,
	BUILTIN_PRINT_LINE_INT,
	BUILTIN_PRINT_FLOAT,
	BUILTIN_PRINT_LINE_FLOAT,
	BUILTIN_PRINT_STRING,
	BUILTIN_PRINT_LINE_STRING,
	BUILTIN_DRAW_RECT,
	...
	BUILTIN_GET_MOUSE_X,
	BUILTIN_GET_MOUSE_Y,
	BUILTIN_GET_MOUSE_BUTTON_INPUT,
	BUILTIN_GET_KEYBOARD_INPUT,
	BUILTIN_GET_KEYBOARD_INPUT_FLAGS,
	BUILTIN_GET_TERMINAL_INPUT_SIZE,
	BUILTIN_READ_TERMINAL_INPUT,
