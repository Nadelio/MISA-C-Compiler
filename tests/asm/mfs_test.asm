...
__str_2:	emb string "No filesystem found, formatting...\n"
__str_3:	emb string "hello.txt"
__str_4:	emb string "Hello from MFS!"
__str_5:	emb string "Read %d bytes: %s\n"
__str_6:	emb string "Updated content."
__str_7:	emb string "After write: %s\n"
__str_10:	emb string "File deleted successfully.\n"
